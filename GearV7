...
sudo cp gear_staging_testnet_v6/network/secret_ed25519 /root/backup
cd $HOME
...
cd $HOME
sudo systemctl stop gear-node
sudo cp /root/backup/secret_ed25519 /root/.local/share/gear-node/chains/gear_staging_testnet_v7/network/secret_ed25519
